...
- 2026-06-07: XNetwork app versioning now uses date-based `YYYY.MM.N` strings. The first scheme entry is `2026.06.1`; `deploy.sh` persists monthly revision state in `.xnetwork-version`, and the version badge opens a changelog `ActionSheet` on mobile and desktop.
