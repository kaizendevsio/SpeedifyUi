...
public class AppChangelogTests
{
    ...
    {
        Assert.Equal("xbond-2026.06.31", AppChangelog.CurrentVersion);
    ...
    public void Changelog_StartsWithCurrentVersion()
    {
        ...
        Assert.Contains(entry.Changes, change => change.Contains("speed test", StringComparison.OrdinalIgnoreCase));
        Assert.Contains(entry.Changes, change => change.Contains("operator", StringComparison.OrdinalIgnoreCase));
    }
