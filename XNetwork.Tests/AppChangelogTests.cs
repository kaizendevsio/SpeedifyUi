...
public class AppChangelogTests
{
    ...
    {
        Assert.Equal("xbond-2026.06.26", AppChangelog.CurrentVersion);
    ...
    public void Changelog_StartsWithCurrentVersion()
    {
        ...
        Assert.Contains(entry.Changes, change => change.Contains("1.1.1.1", StringComparison.OrdinalIgnoreCase));
    }
