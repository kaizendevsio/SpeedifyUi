...
public class AppChangelogTests
{
    ...
    {
        Assert.Equal("ulink-2026.06.135", AppChangelog.CurrentVersion);
    ...
    public void Changelog_StartsWithCurrentVersion()
    {
        ...
        Assert.Contains(entry.Changes, change => change.Contains("steady", StringComparison.OrdinalIgnoreCase));
