...
public class AppChangelogTests
{
    ...
    public void Changelog_StartsWithCurrentVersion()
    {
        ...
        Assert.Contains(entry.Changes, change => change.Contains("provider lookup", StringComparison.OrdinalIgnoreCase));
        Assert.Contains(entry.Changes, change => change.Contains("fifteen minutes", StringComparison.OrdinalIgnoreCase));
