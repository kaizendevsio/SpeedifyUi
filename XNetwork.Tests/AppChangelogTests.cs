...
public class AppChangelogTests
{
    ...
    {
        Assert.Equal("ulink-2026.06.137", AppChangelog.CurrentVersion);
    ...
    public void Changelog_StartsWithCurrentVersion()
    {
        ...
        Assert.Contains(entry.Changes, change => change.Contains("bypass", StringComparison.OrdinalIgnoreCase));
